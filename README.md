...
#### `placebo.Tonemap(clip clip[, int src_csp, int dst_csp, int dst_prim, float src_max, float src_min, float dst_max, float dst_min, int dynamic_peak_detection, float smoothing_period, float scene_threshold_low, float scene_threshold_high, int tone_mapping_function, float tone_mapping_param, bool use_dovi, bool visualize_lut])`
